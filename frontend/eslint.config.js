 ...
 * a number nobody can grep is how the spacing drifted in the first place
 * (#196). gap-10 / mt-10 / p-10 are the 40px utilities; use *-page.
 *
    ...
    rules: {
      'no-restricted-syntax': [
        'error',
        {
          ...
          message: 'Use the named page rhythm (gap-page, mt-page, p-page…) instead of the 40px number. See #196.',
        },
        {
